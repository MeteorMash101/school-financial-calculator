                ...
                <tr className="service">
                  ...
                  <td className
                    ="tableitem"><p className
                      ="itemtext">${tuition.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</p>
                  </td>
                </tr>
                <tr className
                  ="service">
                  ...
                  <td className
                    ="tableitem"><p className
                      ="itemtext">${fee.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</p></td>
                </tr>
                <tr className
                  ="service">
                  <td></td>
                  ...
                  <td className
                    ="tableitem"><p className
                      ="itemtext">${totalFee.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</p></td>
                </tr>
              </tbody>
            </table>
            <div id="table-total">
              <table>
                <tbody>
                  <tr className
                    ...
                    <td className
                      ="payment"><p>-${discount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</p></td>
                  </tr>
                  <tr className
                    ="tabletitle">
                    <td className
                    ...
                    <td></td>
                    <td className
                      ="total"><p>${totalWithDiscount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}*</p></td>
                  </tr>
                </tbody>
              </table>
            </div>
