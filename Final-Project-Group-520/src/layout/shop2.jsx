...
function Shop2(props) {
  ...
  const [loading, setLoading] = useState(true); // makes sure we fetch data before loading content
  const [badContent, setBadContent] = useState(false); // Error checks schools with bad data, for ex: "John F Kennedy Uni."
  let content;
